  ...
  <div class="page-tabs">
    <!-- <div class="tab-box"> -->
      ...
      <el-tabs 
        ...
        <el-tab-pane v-for="page in keepAlivePages" :key="page.url" :label="page.title " :name="page.url" />
      </el-tabs>
    <!-- </div> -->
  </div> 
</template>
...
export default {
  ...
  methods:{
    ...
    // 导入vuex action函数
    ...mapActions('page',[ 'setCurrentPage', 'closeKeepPage', 'closeRightKeepPage', 'closeLeftKeepPage', 'closeOtherKeepPage', 'closeAllKeepPage'])
  }
}
</script>
